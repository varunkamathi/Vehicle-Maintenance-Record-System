...
function RegisterPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full rounded-xl text-slate-700 ">
      ...
      <form onSubmit={handleRegister} className="flex flex-col space-y-4 w-80">
        <input
          ...
          className="p-2 rounded-lg bg-slate-100 border border-gray-400 text-slate-700"
        />
        <input
          type="password"
